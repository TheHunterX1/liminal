...
import net.mcreator.liminal.init.*;
...
@Mod("liminal")
public class LiminalMod {
	public static final Logger LOGGER = LogManager.getLogger(LiminalMod.class);
	public static final String MODID = "liminal";

	public LiminalMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		LiminalModBlocks.REGISTRY.register(modEventBus);
		LiminalModBlockEntities.REGISTRY.register(modEventBus);
		LiminalModItems.REGISTRY.register(modEventBus);
		LiminalModEntities.REGISTRY.register(modEventBus);
		LiminalModTabs.REGISTRY.register(modEventBus);
		LiminalModMenus.REGISTRY.register(modEventBus);
